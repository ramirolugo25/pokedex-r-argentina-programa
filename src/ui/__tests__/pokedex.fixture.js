...
<div class="container">
    ...
    <div class="container">
        <nav aria-label="Page navigation example">
            ...
            <li class="page-item"><a class="page-link" href="pagina-anterior" data-pagina="Anterior">Anterior</a></li>
            <li class="page-item"><a class="page-link" href="#" data-pagina="1">1</a></li>
            <li class="page-item active"><a class="page-link" href="#" data-pagina="2">2</a></li>
            <li class="page-item"><a class="page-link" href="#" data-pagina="3">3</a></li>
            <li class="page-item"><a class="page-link" href="#" data-pagina="4">4</a></li>
            <li class="page-item"><a class="page-link" href="pagina-siguiente" data-pagina="Siguiente">Siguiente</a></li>
            </ul>
        </nav>
    </div>
    <div class="row">
